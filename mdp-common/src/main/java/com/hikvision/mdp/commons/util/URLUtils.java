 ...
 * <p>URL工具类</p>
 *
 * @author chendongsheng5 2016/12/29 20:34
 * @version V1.0
 * @modificationHistory =========================逻辑或功能性重大变更记录
 * @modify by user: chendongsheng5 2016/12/29 20:34
...
public class URLUtils {
	 ...
	 * @return 拼接后的URL
	 */
	@SuppressWarnings("rawtypes") public static String addInnerQueryString(String url, Object obj, String[] names) {
	...
	public static String getExtension(String url) {
		...
		return interrogationIndex == -1 ?
				url.substring(pointIndex + 1) :
	...
	public static String shortenURL(String url, String baseURL) {
		...
		return !ValidateUtils.isEmpty(url) && !ValidateUtils.isEmpty(baseURL) && url.startsWith(baseURL) ?
	 ...
	 * @return
	 */
	public static URL getResourceFileUrl(String file) throws ClassNotFoundException {
		if (file == null)
			return null;

		URL url = Loader.getResource(file,Class.forName("URLUtils").getClassLoader());
		if (url == null) {
